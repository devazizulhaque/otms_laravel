        ...
        <div class="col-md-6 py-5 mx-auto">
            <div class="card">
                <div class="card-header">
                    <h3 class="float-start">Edit Course</h3>
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('courses.update', $course->id) }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row mt-2">
                            ...
                            <div class="col-md-8">
                                <textarea name="long_description" class="form-control" id="longDescription" cols="30" rows="10">{{ $course->long_description }}</textarea>
                            </div>
                        </div>
                        <div class="row mt-2">
